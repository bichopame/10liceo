          ...
          <div className="bg-[#A7E0FF] py-6 px-4 rounded-md flex-1 flex gap-4">
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              ...
              <p className="text-sm text-gray-500">
                Estudiante de destacado.
              </p>
              <div className="p-1 flex items-center justify-between gap-2 flex-wrap text-xs font-medium">
      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-4">
        <div className="bg-white p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
            <Link
              className="p-3 rounded-md bg-lime-300"
              href={`/list/lessons?classId=${student.class.id}`}
            >
              Lecciones
            </Link>
            <Link
              className="p-3 rounded-md bg-teal-300"
            ...
            <Link
              className="p-3 rounded-md bg-yellow-300"
              href={`/list/assignments?classId=${student.class.id}`}
            >
              Asistencia
            </Link>
            <Link
              className="p-3 rounded-md bg-green-300"
