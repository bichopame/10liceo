    ...
    <div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row">
      ...
      <div className="bg-[#A7E0FF] py-6 px-4 rounded-md flex-1 flex gap-4">
        ...
        <div className="w-2/3 flex-col justify-between gap-4">
          <div className="flex items-center gap-4">
            <h1 className="text-xl font-semibold">Pedro Perez Toro</h1>
            <FormModal
              table="teacher"
              type="update"
              data={{
                id:1,
                username:"Pperez",
                email:"pedroperez@colegio.com",
                password:"password",
                firstName: "Pedro",
                lastName:"Perez Toro",
                phone:"+56 9 12345678",
                address:"av. lima 4812, santiago",
                bloodType: "A+",
          ...
          <p className="text-sm text-gray-600 p-1">
            Profesor de Ciencias en la Universidad Andrés Bello, Magister en ciencias de la educación. 
          </p>
      ...
      <div className="bg-white p-4 rounded-md">
        ...
        <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
          <Link className="p-3 rounded-md bg-lime-300" href="/">Clases</Link>
          <Link className="p-3 rounded-md bg-teal-300" href="/">Estudiantes</Link>
          <Link className="p-3 rounded-md bg-orange-300" href="/">Lecciones</Link>
          <Link className="p-3 rounded-md bg-yellow-300" href="/">Examenes</Link>
          <Link className="p-3 rounded-md bg-green-300" href="/">Asistencia</Link>
        </div>
